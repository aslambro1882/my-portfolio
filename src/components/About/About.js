                ...
                <Row className="px-3">
                    ...
                    <Col xs={12} md={6} lg={6}>
                        ...
                        <p className="para" style={{ color: "#7f8c8d", fontSize: "18px", textAlign: 'left' }}>
                            ...
                            Expertise: HTML, CSS, Bootstrap, JavaScript, React Js, React-Bootstrap, Firebase.<br />
                            Comfortable: Node Js, Express Js, MongoDB, Material UI, Figma to HTML Template.<br />
                            Familiar: Tailwind CSS.
                        </p>
                        <div className="resume-div pt-2">
                            <a
                                target="_blank"
                                href="https://drive.google.com/file/d/1eXsAZRezeKY_4ZwDEactAZKrZFBDxB12/view?usp=sharing"
                            >
